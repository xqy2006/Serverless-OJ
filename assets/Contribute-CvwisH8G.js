import{m as d}from"./github-markdown-BOpQ1pHb.js";import{_,e as i,f as p,c as u,a as o,w as e,r as t,o as m,b as n}from"./index-BCFhymPB.js";const f={class:"contribute"},b=["innerHTML"],h={__name:"Contribute",setup(k){const s=i("");return p(async()=>{s.value=d(`#### 准备材料
...
4. 在仓库根目录下运行\`python encrypt.py ./problem/题目名称\`，会生成in.enc和out.enc文件
5. 删除\`题目名称\`文件夹下的in文件和out文件
6. \`git add .\` \`git push\`将本地更改应用到fork仓库中
